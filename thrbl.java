...
public class thrbl
{
    ...
    static class SegmentTree {
        ...
        public int query (int a, int b) {
            ...
            int mid = (start + end) >> 1;
            if (mid >= b) return Lchild.query (a, b);
            else if (mid < a) return Rchild.query (a, b);
            else return Math.max (Lchild.query (a, mid), Rchild.query (mid + 1, b));
        }
    }
